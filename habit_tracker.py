...
#     # Convert history to date objects
...
#     # Check if habit was done yesterday or today for current streak
#     if dates[-1] == today:
...
#     # Completion rate = (total completions) / (days since created)
...
#     created_date = datetime.strptime(habit["created"], "%Y-%m-%d").date()
#     days_active = (today - created_date).days + 1
#     completion_rate = f"{round((unique_days / days_active) * 100)}%"
